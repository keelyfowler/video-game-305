...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF9CC5A1);
  late Color secondary = const Color(0xFF177BDD);
  late Color tertiary = const Color(0xFF57886C);
  late Color alternate = const Color(0xFF445552);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFC3D7C6);
  late Color secondaryBackground = const Color(0xFF818E82);
  late Color accent1 = const Color(0xFF4A4D4D);
